...
async def generate_daily_bias_report(symbol: str, provider: "BaseProvider") -> str:
    ...
    trend = "🟢 Bullish" if above_sma5 and above_sma20 else (
        "🔴 Bearish" if not above_sma5 and not above_sma20 else "🟡 Mixed"
    )
    ...
    try:
        ...
        if chain:
            ...
            if gex_data:
                ...
                gex_section = f"\n### ⚡ Key GEX Level\n- **${max_gex['strike']:.0f}** — {max_gex['gex']:,.0f} GEX (major gamma pin)\n"
    except Exception:
        pass
...
|-----------|-------|--------|
| SMA 5 | ${sma5:.2f} | {'Above ✅' if above_sma5 else 'Below ❌'} |
| SMA 20 | ${sma20:.2f} | {'Above ✅' if above_sma20 else 'Below ❌'} |
{gex_section}
## Bias Summary
...
*Generated by CrystalBall — [crystalball.dev](https://crystalball.dev)*
"""
    return report
